...
const MenSection = () => {
  const Data = useSelector((state) => state.MensItemsData);
    ...
    <div>
      <div className="relative w-full text-center py-12 px-4 bg-gradient-to-r from-blue-50 via-white to-blue-50">
        ...
        <p className="relative mt-2 text-base sm:text-lg md:text-xl text-gray-700 max-w-3xl mx-auto">
          Discover a refined selection of classic styles and modern essentials,
          tailored for sophistication and comfort.
        </p>
      ...
      <React.Suspense fallback={<div>Loading...</div>}>
        <FilterList allProducts={Data} dataTestid="Mens-Items" />
      </React.Suspense>
    </div>
  );
};
